...
class UserResponseModelHateoas {
	...
	fun toModel(userResult: UserResult, ordersResult: OrdersResult? = null): EntityModel<UserResponse> {
		val entityModel = EntityModel.of(UserResponse.of(userResult, ordersResult))
